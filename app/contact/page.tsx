  ...
  return (
    <main className="bg-white text-black">
      <section className="bg-jet text-white py-14 px-4 text-center">
        <p className="text-orange font-semibold text-sm uppercase tracking-wide mb-2">Get In Touch</p>
        <h1 className="text-3xl sm:text-5xl font-black">Contact NGMS</h1>
      ...
      <section className="max-w-2xl mx-auto px-4 py-14 grid sm:grid-cols-2 gap-6 text-center">
        <a
          ...
          className="border border-gray-200 rounded-2xl p-8 hover:border-eco transition"
        >
          <p className="font-bold text-lg mb-1">WhatsApp</p>
          <p className="text-gray-600 text-sm">063 138 7945</p>
        </a>
        <a
        ...
        >
          ...
          <p className="text-gray-600 text-sm">info.nextgensolution1@gmail.com</p>
        </a>
      </section>

      <section className="bg-graphite text-white text-center py-10 px-4">
        <p className="text-gray-400 mb-4">Serving Strand, Gordon’s Bay, Somerset West and the Helderberg Basin</p>
        <a href="/quote" className="bg-orange hover:bg-orange-dark text-white font-semibold px-6 py-3 rounded-full inline-block">
          Get a Free Quote
        </a>
      </section>
    </main>
